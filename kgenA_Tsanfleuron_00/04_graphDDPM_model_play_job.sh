...
# ------------------------------------------------------------------------------
#SBATCH --job-name=04_graphDDPM_model_play  # variable: SLURM_JOB_NAME
...
#SBATCH --time=2:00:00              # limit on the total run time, format:
                                    #    "minutes"
                                    #    "minutes:seconds"
...
python 04_graphDDPM_model_play.py
t2=$(date --iso-8601=ns)
