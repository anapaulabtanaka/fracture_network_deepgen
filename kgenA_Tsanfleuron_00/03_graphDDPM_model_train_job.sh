...
# ------------------------------------------------------------------------------
#SBATCH --job-name=03_graphDDPM_model_train  # variable: SLURM_JOB_NAME
...
#SBATCH --time=2-0:00:00              # limit on the total run time, format:
                                    #    "minutes"
                                    #    "minutes:seconds"
...
python 03_graphDDPM_model_train.py
t2=$(date --iso-8601=ns)
