...
G_list_data_set = [extract_subgraph_from_bfs(G_main, n, pos_attr='pos', n_start_candidates=10) for n in n_nodes]
...
G_list_test_set = [extract_subgraph_from_bfs(G_main, n, pos_attr='pos', n_start_candidates=10) for n in n_nodes]
